...
const Footer = () => (
  <>
    <footer className=" bg-dark-blue p-10 lg:p-20 flex flex-col lg:flex-row lg:items-start lg:gap-24 gap-4 items-center">
      <div>
        <div>
        ...
        <div className="flex gap-4 my-10">
          ...
          >
            <path
              className=" group-hover:fill-lime-green"
              fill="#FFF"
      ...
      <div className="flex flex-col gap-4 items-center">
        <a href="#" className=" text-white hover:text-lime-green">
          About Us
        </a>
        <a href="#" className=" text-white hover:text-lime-green">
          Contact
