  ...
  return (
    <>
      <div className="grid md:grid-cols-2 bg-very-light-gray">
        ...
        md:col-start-2  bg-no-repeat bg-cover md:bg-[length:200%] bg-left md:bg-[8%] "
        >
          <img
            src={imageMockup}
            className=" absolute bottom-0 md:left-20 w-5/6 md:max-w-none  max-w-96"
            alt=""
          />
        </div>
        <div className=" md:row-start-1 px-10 md:px-20 py-10 pb-20 text-center md:text-left">
          <h3 className=" text-5xl md:mt-16 text-dark-blue">
